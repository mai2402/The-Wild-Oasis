  ...
  { label: "Feb 06", totalSales: 1450, extrasSales: 400 },
    ...
    function SalesChart({bookings, numDays}) {
      ...
      return (<>
        ...
        <StyledSalesChart>
        <Heading as="h2">Sales from {format(allDates.at(0), "MMM dd yyyy")} &mdash;{format(allDates.at(-1), "MMM dd yyyy")}
      </Heading>
